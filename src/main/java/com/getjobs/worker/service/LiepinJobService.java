    ...
    public void executeDelivery(Consumer<JobProgressMessage> progressCallback) {
        ...
        try {
            ...
            if (overrides != null && !overrides.isEmpty()) {
                com.getjobs.delivery.service.ConfigOverrideApplier.applyLiepin(config, overrides);
                log.info("Liepin 配置已按投递中心 platform_configs 覆盖：keywords={} city={} salary={}", config.getKeywords(), config.getCityCode(), config.getSalary());
            }
