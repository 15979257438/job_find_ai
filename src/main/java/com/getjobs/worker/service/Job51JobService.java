    ...
    public void executeDelivery(Consumer<JobProgressMessage> progressCallback) {
        ...
        try {
            ...
            if (overrides != null && !overrides.isEmpty()) {
                com.getjobs.delivery.service.ConfigOverrideApplier.applyJob51(config, overrides);
                log.info("Job51 配置已按投递中心 platform_configs 覆盖：keywords={} jobArea={}", config.getKeywords(), config.getJobArea());
            }
